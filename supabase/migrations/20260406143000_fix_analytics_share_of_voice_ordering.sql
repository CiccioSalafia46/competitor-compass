-- Follow-up fix for already-linked databases: preserve quoted camelCase aliases
-- when ordering the share-of-voice payload inside get_workspace_analytics().
...
GRANT EXECUTE ON FUNCTION public.get_workspace_analytics(uuid, integer) TO authenticated;
