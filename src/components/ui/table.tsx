...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "group border-b border-border/50 transition-colors duration-100",
      "hover:bg-muted/15",
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("px-4 py-2.5 align-middle first:pl-5 last:pr-5 [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
));
